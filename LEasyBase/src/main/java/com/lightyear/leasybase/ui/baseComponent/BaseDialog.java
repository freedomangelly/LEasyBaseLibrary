...
import com.lightyear.leasybase.ui.action.ActivityAction;
import com.lightyear.leasybase.ui.action.AnimAction;
import com.lightyear.leasybase.ui.action.ClickAction;
import com.lightyear.leasybase.ui.action.HandlerAction;
import com.lightyear.leasybase.ui.action.KeyboardAction;
import com.lightyear.leasybase.ui.action.ResourcesAction;
...
public class BaseDialog extends AppCompatDialog implements LifecycleOwner,
    ...
    public static class Builder<B extends Builder> implements
        ...
        private SparseArray<OnItemClickListener> mClickArray2;
         ...
         * 设置点击事件
         */
        public B setOnItemClickListener(@IdRes int id, @NonNull BaseDialog.OnItemClickListener listener) {
            if (mClickArray2 == null) {
                mClickArray2 = new SparseArray<>();
            }
            mClickArray2.put(id, listener);

            if (isCreated()) {
                AdapterView view = mDialog.findViewById(id);
                if (view != null) {
                    view.setOnItemClickListener(new ViewItemClickWrapper(mDialog, listener));
                }
            }
            return (B) this;
        }
        ...
        public BaseDialog create() {
            ...
            for (int i = 0; mClickArray2 != null && i < mClickArray2.size(); i++) {
                AdapterView view = mContentView.findViewById(mClickArray2.keyAt(i));
                if (view != null) {
                    view.setOnItemClickListener(new ViewItemClickWrapper(mDialog, mClickArray2.valueAt(i)));
                }
            }
    ...
    private static final class ViewItemClickWrapper
            implements AdapterView.OnItemClickListener {

        private final BaseDialog mDialog;
        private final BaseDialog.OnItemClickListener mListener;

        private ViewItemClickWrapper(BaseDialog dialog, BaseDialog.OnItemClickListener listener) {
            mDialog = dialog;
            mListener = listener;
        }
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            mListener.onItemClick(mDialog,view,i,l);
        }
    }
    ...
    public interface OnItemClickListener<V extends View> {
        void onItemClick(BaseDialog dialog, V view, int position, long itemId);
    }
