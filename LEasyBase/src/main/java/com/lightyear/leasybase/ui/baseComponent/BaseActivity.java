...
import com.lightyear.leasybase.ioc.ViewUtils;
import com.lightyear.leasybase.ui.action.ActivityAction;
import com.lightyear.leasybase.ui.action.BundleAction;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void initLayout() {
        if (getLayoutView() != null) {
            setContentNewView(getLayoutView());
            initSoftKeyboard();
    ...
    private void setContentNewView(View view) {
        try {
    ...
    public void setViewVisbile(View view,int type){
