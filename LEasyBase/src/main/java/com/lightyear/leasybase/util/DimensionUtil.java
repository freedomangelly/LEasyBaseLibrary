package com.lightyear.leasybase.util;
...
public class DimensionUtil {
    ...
    public static void init(Context context) {
        if(mDimensionUtil == null) {
            mDimensionUtil = new DimensionUtil(context);
        }
    }

    private DimensionUtil(Context context) {
        initValues(context,DEF_WIDTH, DEF_HEIGHT);
    }

    private void initValues(Context context,float ipWidth, float ipHeight) {
